...
export class ClienteWAService {
  URL_APIS: string = environment.backendUrl;
  ...
  login(form: any) {
    return this.http.post(this.URL_LOGIN, form.getRawValue(), {
      headers,
  ...
  obtenerCaracterizaciones() {
    return this.http.get(this.URL_CARACTERIZACION, {
      headers,
      withCredentials: true,
    });
  }
  ...
  obtenerSectores() {
    return this.http.get(this.URL_SECTORIZACION, {
      headers,
      withCredentials: true,
    });
  }
  ...
  obtenerActividades() {
    return this.http.get(this.URL_ACTIVIDADES, {
      headers,
      withCredentials: true,
    });
  }
  ...
  ingresarInstitucion(form: any) {
    return this.http.post(this.URL_INGRESAR_INSTITUCION, form.value, {
      headers,
      withCredentials: true,
    });
  }
